...
import com.best.app.patientmedicalfile.PackageDoctor.DiseaseActivity;
import com.best.app.patientmedicalfile.PackageDoctor.DoctorViewPatientActivity;
import com.best.app.patientmedicalfile.PackageDoctor.MedicalInfoActivity;
import com.best.app.patientmedicalfile.PackageDoctor.ReportActivity;
import com.best.app.patientmedicalfile.PackageDoctor.ViewDiseaseActivity;
import com.best.app.patientmedicalfile.PackageDoctor.ViewMedicalInfoActivity;
import com.best.app.patientmedicalfile.PackageDoctor.ViewReportAActivity;
    ...
    private class CenterAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btnActive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    UpdateFunction update = new UpdateFunction(item.getUserid(), "patient");
                    update.execute();
                }
            });
